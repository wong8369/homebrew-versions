class PhpAT56 < Formula
  ...
  bottle do
   ...
   #rebuild 2
   sha256 "8ba85b33ddb13375556e1a91e4cf518441fcf62172ba2d43fd945a5f1a6e3dfe" => :mojave
  end
  ...
  def install
    ...
    args = %W[
      ...
      --with-openssl=#{HOMEBREW_PREFIX}/opt/openssl@1.0.2t
    ...
    inreplace "Makefile", "-lssl ", " "
    inreplace "Makefile", "-lcrypto ", " "
    inreplace "Makefile", "-lmcrypt ", "-lmcrypt #{HOMEBREW_PREFIX}/opt/openssl@1.0.2t/lib/libssl.dylib #{HOMEBREW_PREFIX}/opt/openssl@1.0.2t/lib/libcrypto.dylib "
